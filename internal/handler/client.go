...
func (h *ClientHandler) GetClients(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	clients, err := h.clientService.GetClients(ctx)
...
func (h *ClientHandler) GetClientById(w http.ResponseWriter, r *http.Request) {
	...
	client, err := h.clientService.GetClientById(ctx, id)
...
func (h *ClientHandler) CreateClient(w http.ResponseWriter, r *http.Request) {
	...
	savedClient, err := h.clientService.CreateClient(ctx, &saveDto)
...
func (h *ClientHandler) UpdateClient(w http.ResponseWriter, r *http.Request) {
	...
	client, err := h.clientService.UpdateClient(ctx, &updateDto)
	if err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
...
func (h *ClientHandler) DeleteClient(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.clientService.DeleteClient(ctx, id); err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
	}
