...
func (r *ClientRepository) GetClients(ctx context.Context) ([]*model.Client, error) {
...
func (r *ClientRepository) GetClientById(ctx context.Context, id int) (*model.Client, error) {
	var client model.Client
